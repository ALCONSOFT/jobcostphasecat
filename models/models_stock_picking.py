...
class ZZ_StockPicking(models.Model):
    ...
    def action_assign(self):
        ...
        for move in self.move_ids:
            ...
            # SOLO validar ubicaciones INTERNAS (ignorar virtuales)
            # Las ubicaciones virtuales (Vendors, Customers, etc.) no tienen stock físico
            if move.location_id.usage != 'internal':
                _logger.info(
                    "Saltando validación de stock para ubicación NO interna: %s (tipo: %s)",
